    ...
    return (
        <footer className="mt-20 bg-white bg-opacity-50 backdrop-blur-lg">
            ...
            <div className="px-6 py-6 md:flex md:items-center md:justify-between">
                <span className="text-sm text-black sm:text-center">© 2023 GoatVote. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 md:mt-0">
                    <a href="https://github.com/dunyanong/GoatVote" className="text-black hover:text-gray-400" target="_blank">
