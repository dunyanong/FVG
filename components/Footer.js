        ...
        <footer className="md:px-20 lg:px-20 pb-8 md:py-0 lg:py-0 h-auto bg-white bg-opacity-50 backdrop-blur-lg">
            <div className="grid grid-cols-2 gap-8 px-6 pt-8  md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul className="text-gray-500">
                        <li className="mb-4">
                            <a href="https://github.com/dunyanong/FVG/blob/main/LICENSE" className="hover:underline" target="_blank">Licensing</a>
                        </li>
                        <li className="mb-4">
            ...
            <div className="px-6 py-6 md:flex md:items-center md:justify-between">
                <span className="text-sm text-black sm:text-center">© 2023 FVG. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 md:mt-0">
                    <a href="https://github.com/dunyanong/FVG" className="text-black hover:text-gray-400" target="_blank">
